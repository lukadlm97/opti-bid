/* add contact type script*/
insert into ContactTypes (Name) values('Email')
insert into ContactTypes (Name) values('Phone')
insert into ContactTypes (Name) values('Twitter')
insert into ContactTypes (Name) values('Facebook')
insert into ContactTypes (Name) values('Instagram')
insert into ContactTypes (Name) values('WhatsApp')
insert into ContactTypes (Name) values('Viber')
insert into ContactTypes (Name) values('Telegram')
insert into ContactTypes (Name) values('Signal')


/* add countries script */
...
(8, 'AQ', 'ANTARCTICA', 'Antarctica', 'UNK'),
...
(29, 'BV', 'BOUVET ISLAND', 'Bouvet Island', 'UNK'),
(30, 'BR', 'BRAZIL', 'Brazil', 'BRA'),
(31, 'IO', 'BRITISH INDIAN OCEAN TERRITORY', 'British Indian Ocean Territory', 'UNK'),
...
(45, 'CX', 'CHRISTMAS ISLAND', 'Christmas Island', 'UNK'),
(46, 'CC', 'COCOS (KEELING) ISLANDS', 'Cocos (Keeling) Islands', 'UNK'),
...
(76, 'TF', 'FRENCH SOUTHERN TERRITORIES', 'French Southern Territories', 'UNK'),
...
(93, 'HM', 'HEARD ISLAND AND MCDONALD ISLANDS', 'Heard Island and Mcdonald Islands', 'UNK'),
...
(112, 'KP', 'KOREA, DEMOCRATIC PEOPLES REPUBLIC OF', 'Korea, Democratic Peoples Republic of', 'PRK'),
(113, 'KR', 'KOREA, REPUBLIC OF', 'Korea, Republic of', 'KOR'),
(114, 'KW', 'KUWAIT', 'Kuwait', 'KWT'),
(115, 'KG', 'KYRGYZSTAN', 'Kyrgyzstan', 'KGZ'),
(116, 'LA', 'LAO PEOPLES DEMOCRATIC REPUBLIC', 'Lao Peoples Democratic Republic', 'LAO'),
...
(164, 'PS', 'PALESTINIAN TERRITORY, OCCUPIED', 'Palestinian Territory, Occupied', 'UNK'),
...
(189, 'CS', 'SERBIA AND MONTENEGRO', 'Serbia and Montenegro', 'UNK'),
...
(198, 'GS', 'SOUTH GEORGIA AND THE SOUTH SANDWICH ISLANDS', 'South Georgia and the South Sandwich Islands', 'UNK'),
...
(212, 'TL', 'TIMOR-LESTE', 'Timor-Leste', 'UNK'),
...
(227, 'UM', 'UNITED STATES MINOR OUTLYING ISLANDS', 'United States Minor Outlying Islands', 'UNK'),
...
/* add professions script*/

insert into Professions values
('Managers'),  ('Professional')  ,('Technicians and associate professionals'),(' Clerical support workers'),('Service and sales workers'),('Skilled agricultural, forestry and fishery workers')
,('Craft related trades workers'),('Plant and machine operators, and assemblers'),('Elementary occupations'),('Armed forces occupations');
